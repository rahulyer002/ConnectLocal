...
.bt-loc-search-wrap {
  ...
  padding: 12px 16px;
  background: #ffffff;
  border: 1.5px solid rgba(29, 113, 105, 0.22);
  border-radius: 16px;
  transition: border-color 0.2s, box-shadow 0.2s, background 0.2s;
}

.bt-loc-search-wrap:focus-within {
  border-color: #0a9b8a;
  box-shadow: 0 0 0 3px rgba(10, 155, 138, 0.12);
}
...
.bt-loc-clear {
  ...
  border-radius: 50%;
  border: none;
  background: rgba(29, 113, 105, 0.08);
  color: #1d7169;
  cursor: pointer;
...
.bt-loc-clear:hover {
  background: rgba(29, 113, 105, 0.16);
}
...
.bt-loc-spin {
  ...
  height: 14px;
  border-radius: 50%;
  border: 2px solid rgba(10, 155, 138, 0.25);
...
.bt-loc-suggestions {
  ...
  margin: 0;
  background: white;
  border: 1px solid rgba(10, 155, 138, 0.16);
  border-radius: 14px;
  padding: 6px;
...
.bt-loc-btn.locate {
  background: #f0faf0;
  border-color: rgba(29, 113, 105, 0.18);
  color: #0a9b8a;
}

.bt-loc-btn.locate:hover:not(:disabled) {
  background: #0a9b8a;
  color: white;
  border-color: #0a9b8a;
}
...
.bt-loc-btn.search:hover:not(:disabled) {
  background: #0a9b8a;
}
