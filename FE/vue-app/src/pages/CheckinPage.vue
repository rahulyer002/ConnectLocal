        ...
        <div class="info-grid">
          <div class="info-card" data-reveal>
            ...
            <div class="info-text">
              ...
              <p :style="{ fontSize: scaledPx(16) }">
                Easy to answer, no right or wrong. Just how you honestly feel right now.
              </p>
            </div>
          </div>
          ...
          <div class="info-card" data-reveal>
            ...
            <div class="info-text">
              ...
              <p :style="{ fontSize: scaledPx(16) }">
                See which areas of connection are going well and which need a little attention.
              </p>
            </div>
          </div>
          ...
          <div class="info-card" data-reveal>
            ...
            <div class="info-text">
              ...
              <p :style="{ fontSize: scaledPx(16) }">
                Discover free, nearby events chosen to suit your situation and interests.
              </p>
            </div>
          </div>
        </div>
...
.info-card:hover {
  ...
  box-shadow: 0 18px 44px rgba(10,155,138,0.1);
}
...
.start-btn:hover {
  transform: translateY(-3px);
  box-shadow: 0 24px 52px rgba(10,155,138,0.42);
}

.start-btn:focus-visible {
  outline: 3px solid #0a9b8a;
  outline-offset: 3px;
}
